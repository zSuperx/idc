...
pub enum LirInstr {
		...
		Zext(LirType, LirVal, LirVal, LirVal),
		Sext(LirType, LirVal, LirVal, LirVal),
		Trunc(LirType, LirVal, LirVal, LirVal),
		Copy(LirType, LirVal, LirVal),
		Alloc(LirType, LirVal, StringId),
		Arg(LirType, LirVal, StringId, usize),
		Stkarg(LirType, LirVal, StringId, usize),
		Load(LirType, LirVal, LirVal),
		Store(LirType, LirVal, LirVal),
		Comment(String),
		Retv,
		Ret(LirType, LirVal),
		Br(LirType, LirVal, BB, BB),
		Jmp(BB),
}

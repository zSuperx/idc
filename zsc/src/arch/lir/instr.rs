...
pub enum LirInstr {
		...
		Zext(TypeId, LirVal, LirVal, LirVal),
		Sext(TypeId, LirVal, LirVal, LirVal),
		Trunc(TypeId, LirVal, LirVal, LirVal),
...
impl std::fmt::Display for LirInstr {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
						...
						Self::Zext(v0, v1, v2, v3) => f.write_fmt(format_args!("zext {v0}, {v1}, {v2}, {v3}")),
						Self::Sext(v0, v1, v2, v3) => f.write_fmt(format_args!("sext {v0}, {v1}, {v2}, {v3}")),
						Self::Trunc(v0, v1, v2, v3) => f.write_fmt(format_args!("trunc {v0}, {v1}, {v2}, {v3}")),
...
impl Instr for LirInstr {
    ...
    fn srcs(&mut self) -> impl Iterator<Item = &mut Self::Val> {
        match self {
						...
						Self::Zext(v0, v1, v2, v3) => vec![v2, v3].into_iter(),
						Self::Sext(v0, v1, v2, v3) => vec![v2, v3].into_iter(),
						Self::Trunc(v0, v1, v2, v3) => vec![v2, v3].into_iter(),
    ...
    fn dsts(&mut self) -> impl Iterator<Item = &mut Self::Val> {
        match self {
						...
						Self::Zext(v0, v1, v2, v3) => vec![v1].into_iter(),
						Self::Sext(v0, v1, v2, v3) => vec![v1].into_iter(),
						Self::Trunc(v0, v1, v2, v3) => vec![v1].into_iter(),
    ...
    fn is_terminator(&self) -> bool {
        match self {
						...
						Self::Zext(v0, v1, v2, v3) => false,
						Self::Sext(v0, v1, v2, v3) => false,
						Self::Trunc(v0, v1, v2, v3) => false,
